...
spirometer_read_overview.html - HTML overview documentation file for the generated 
                                component. It contains the requirements for accessing the 
                                component and for generating arguments using the MWArray 
                                class hierarchy.

spirometer_read.xml - This file contains the code comments for the spirometer_read 
                                ...
                                documentation for the spirometer_read component.
